...
By default, `read_muse_xml_meta` returns the meta data related to Muse versions, patient and test demographics, resting ECG measurements, and original resting ECG measurements.  The returned object is a named list of data frames (or tibbles). The function can take a file path or a collection of file paths.  If more than one file path is present, the results are appended together.
